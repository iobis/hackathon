...
For many research questions we are interested in the environmental conditions where a certain species, population, or community lives. OBIS already provides some environmental data along with the records. For example, if you download records for the species _Actinia equina_, you can easily obtain values for sea surface temperature (SST), salinity (SSS), and bathymetry:
